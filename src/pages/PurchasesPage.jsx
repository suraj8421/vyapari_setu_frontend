            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <button onClick={openNew} className="btn-primary">
                        <HiOutlinePlus className="w-5 h-5" /> {t('purchases.newPurchase')}
                    </button>
                </div>
            </div>
                    ...
                    {items.map((item, idx) => (
                        <div key={idx} className="grid grid-cols-12 gap-2 p-3 rounded-xl bg-surface-800/30">
                            ...
                            <div className="col-span-1">
                                <button type="button" onClick={() => items.length > 1 && setItems(items.filter((_, i) => i !== idx))} className="p-2 text-red-400">
                                    <HiOutlineTrash className="w-4 h-4" />
                                </button>
                            </div>
                        </div>
                    ))}
                    <button type="button" onClick={() => setItems([...items, { productId: '', quantity: 1, unitPrice: 0, gstRate: 0 }])} className="btn-ghost btn-sm text-primary-400">
